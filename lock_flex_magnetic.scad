 ...
 * Flex Magnet
 */
module flex_magnetic_positive(magnet_hole=6) {
    if (magnet_hole > 0) {
        ...
        hull() {
            ...
            translate([0,-magnet_hole/2-1,.4]) cube([magnet_hole/2+1,magnet_hole+2,5.6]);
        }
    }
}

module flex_magnetic_negative(magnet_hole=6) {
    if (magnet_hole > 0) {
...
module flex_magnetic_hex(square_basis, magnet_hole=6) {
    if (magnet_hole > 0) {
        hull() {
            translate([square_basis/2,0,0]) rotate([0,0,90]) translate([magnet_hole/2+1,0,1]) cylinder(8,magnet_hole/2,magnet_hole/2, $fn=100);
            rotate([0,0,-120]) mirror([1,0,0]) translate([square_basis/2,0,0]) rotate([0,0,90]) translate([magnet_hole/2+1,0,1]) cylinder(8,magnet_hole/2,magnet_hole/2, $fn=100);
        }
